...
if(id > 1 && id < 1025) {
    mainDOM.innerHTML += `<a href="card.html?id=${id+1}">next</a><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${id}.png" alt="${data.name}"><a href="card.html?id=${id-1}">prev</a>`;
} else if(id == 1) {
    mainDOM.innerHTML += `<a href="card.html?id=${id+1}">next</a><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${id}.png" alt="${data.name}"><a href="card.html?id=${1025}">prev</a>`;
} else if(id == 1025) {
    mainDOM.innerHTML += `<a href="card.html?id=${1}">next</a><img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${id}.png" alt="${data.name}"><a href="card.html?id=${id-1}">prev</a>`;
} 
...
mainDOM.innerHTML += `
    <section class="about">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc iaculis eros vitae tellus condimentum maximus sit amet in eros.</p>
    </section>
    <section class="stats">
        <h2>Base Stats</h2>
        <div>
